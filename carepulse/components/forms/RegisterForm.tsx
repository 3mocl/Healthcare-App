      ...
      >
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormFeild
            ...
            name="address"
            label="Address"
            placeholder="Kadri Hills Apartments, Mangalore"
          />
          <CustomFormFeild
            fieldType={FormFieldType.INPUT}
            control={form.control}
        ...
        <div className="flex flex-col gap-6 xl:flex-row">
          ...
          <CustomFormFeild
            ...
            placeholder="Asprin, Allegry Pills, Paracetamol, etc..."
          />
        </div>
        <div className="flex flex-col gap-6 xl:flex-row">
          <CustomFormFeild
            ...
            placeholder="Heart Conditions, Cancer History, etc..."
          />
          <CustomFormFeild
            fieldType={FormFieldType.TEXTAREA}
            control={form.control}
        ...
        <CustomFormFeild
          ...
          label="I Consent to Recieve Treatment"
        />
        ...
        <CustomFormFeild
          ...
          control={form.control}
          name="privacyConsent"
          label="I Consent to the Privacy Policies"
        />
